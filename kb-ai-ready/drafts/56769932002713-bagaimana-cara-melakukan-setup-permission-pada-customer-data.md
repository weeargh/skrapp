...
1. Masuk ke akun Mekari Qontak dan buka menu **Settings**.
   → Halaman Settings ditampilkan.

2. Klik tab **Customizations** dan pilih **Customers**.
   → Halaman Customizations - Customers terbuka.

3. Klik **Create field** atau pilih field yang sudah ada.
   → Formulir pembuatan field atau detail field ditampilkan.

4. Lanjutkan ke tahap **Field Setup** dan klik **Add user**.
   → Panel pemilihan pengguna/role muncul.

5. Klik ikon 'tambah' untuk memilih pengguna berdasarkan role mereka. Gunakan ikon **filter** untuk mempermudah pencarian.
   → Daftar pengguna sesuai filter ditampilkan.

6. Klik **Apply** setelah memilih pengguna.
   → Pengguna terpilih muncul di halaman Field Setup.

7. Tentukan jenis permissions yang sesuai untuk setiap pengguna (baca, edit, atau akses terbatas).
...
• Field dengan masking berhasil dikonfigurasi dan muncul di halaman Customer Data Platform
