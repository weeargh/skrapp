---
title: Bagaimana Cara Setting Jam Kerja
canonical_url: https://help-center.qontak.com/hc/id/articles/5494669211417-Bagaimana-Cara-Setting-Jam-Kerja
article_type: task
...
- general-platform
query_examples:
- Cara Setting Jam Kerja
- Bagaimana cara Setting Jam Kerja?
- Langkah-langkah Setting Jam Kerja di Qontak CRM
- How do I Setting Jam Kerja?
- Mau Setting Jam Kerja, caranya gimana?
...
Untuk mengatur jam kerja di Qontak CRM, Anda memerlukan:

• Akun Mekari Qontak CRM aktif
• Akses dengan role Admin atau izin untuk mengelola User Permission
• Minimal satu user terdaftar dalam sistem yang akan diatur jam kerjanya
• Akses ke menu Profile Settings pada dashboard Qontak CRM

Pengaturan jam kerja digunakan untuk tracking kehadiran karyawan melalui fitur Tracking Time, termasuk pencatatan waktu check-in dan check-out.
...
Jika Anda mengalami masalah saat mengatur jam kerja di Qontak CRM, hubungi tim support Mekari Qontak dengan informasi berikut:

• ID akun Qontak CRM Anda
• Nama user yang mengalami masalah
• Screenshot halaman Tracking Time yang bermasalah
• Deskripsi lengkap tentang masalah yang dihadapi
• Zona waktu dan jam kerja yang ingin diatur

Tim support siap membantu mengatasi hambatan teknis dalam pengaturan jam kerja.