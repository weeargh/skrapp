...
1. Login ke akun Qontak Omnichannel Anda menggunakan kredensial Admin. Dashboard utama akan ditampilkan.

2. Buka menu Settings di bagian pengaturan dashboard. Halaman Settings akan ditampilkan.

3. Pilih tab User Management. Sistem akan menampilkan halaman User Management dengan daftar user yang sudah terdaftar.

4. Klik tombol Add new user untuk menambahkan user baru. Form input user baru akan ditampilkan.
...
- User baru akan muncul di daftar tabel user pada halaman User Management
