...
1. Klik tanda panah yang terletak di sebelah kanan nama username Anda di bagian atas kanan dasbor CRM. Menu dropdown akan muncul.
2. Pilih "Profile Settings" dari menu dropdown. Halaman pengaturan profil akan terbuka.
3. Klik tombol "Add user" yang terletak di sebelah kanan atas halaman. Formulir penambahan pengguna baru akan ditampilkan.
