---
title: Bagaimana Cara Mengedit Deal Access
canonical_url: https://help-center.qontak.com/hc/id/articles/5486351799065-Bagaimana-Cara-Mengedit-Deal-Access
article_type: task
...
- general-platform
query_examples:
- Cara Mengedit Deal Access
- Bagaimana cara Mengedit Deal Access?
- Langkah-langkah Mengedit Deal Access di Qontak CRM
- How do I Mengedit Deal Access?
- Mau Mengedit Deal Access, caranya gimana?
...
• User yang akan diatur Deal Access-nya harus sudah terdaftar dalam sistem
• Identifikasi user mana yang ingin Anda atur akses datanya (View, Edit, Search Association, Delete, Upload, Download)
...
Jika pengaturan Deal Access tidak tersimpan atau Anda mengalami kendala:
• Screenshot halaman User Permissions saat error muncul
• Informasi email atau ID user yang akan diatur akses datanya
• Deskripsi error atau pesan yang ditampilkan sistem
• Hubungi tim support Qontak melalui help center dengan informasi di atas untuk mendapatkan bantuan teknis.