---
title: Overview Menu Tickets
canonical_url: https://help-center.qontak.com/hc/id/articles/22325123122201-Overview-Menu-Tickets
...
query_examples:
- Apa itu Menu Tickets?
- Apa fungsi Menu Tickets di Qontak CRM?
- Penjelasan Menu Tickets
- What is Menu Tickets?
- Bagaimana cara kerja Menu Tickets?
...
• Tab Filter Ticket untuk pengelompokan berdasarkan kategori
• Fitur Download untuk ekspor tiket dalam mode Table View atau Board View
• Sistem prioritas (Low, Medium, High, Critical)
• Tahapan pipeline yang dapat disesuaikan (New, Assigned, In Progress, Done)
• SLA Target untuk menetapkan batas waktu penyelesaian
• Field asosiasi (Contact, Company, Product, Task)
• Dua tampilan: Board View (kolom kotak) dan Table View (daftar)
• Search bar untuk pencarian tiket spesifik
• Tombol Actions (Edit, Duplicate, Delete) per tiket
...
• Filter Ticket (untuk pengelompokan dan penyaringan tiket)
• Mengubah tampilan tiket antara Board View dan Table View